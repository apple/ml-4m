...
from ..data_constants import DEFAULT_CROP_PCT, IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
...
def create_transform(
    ...
    if is_training and no_aug:
        ...
        transform = transforms_imagenet_eval(
            img_size, interpolation=interpolation, use_prefetcher=use_prefetcher, mean=mean, std=std, crop_pct=crop_pct
        )
